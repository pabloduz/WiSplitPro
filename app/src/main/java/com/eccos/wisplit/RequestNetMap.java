...
public class RequestNetMap extends SupportMapFragment implements OnMapReadyCallback, GoogleMap.OnInfoWindowClickListener {

    private GoogleMap mMap;

    private static final String TAG = "RequestNetMap";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        fab = getActivity().findViewById(R.id.fab); handler = new Handler();
    ...
    public void onResume() {
        ...
        if (MainActivity.isNetworkAvailable(getActivity())) {
            if (firstExecution) {
                showSnackBar(R.string.find_req);

                firstExecution = false;

            } else {
                showSnackBar(R.string.add_req);
...
//                                        Log.e("UPDATE", "Camera Idle");
            ...
            fab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent myIntent = new Intent(getActivity(), AddReq.class);
...
//        Log.e("RADIUS", "" + radius);
    ...
    public void updateMapMarker(DataSnapshot dataSnapshot){
        try{
            ...
            Firebase ref = myFirebaseRef.child("requests").child(key);
            ...
            ref.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(com.firebase.client.DataSnapshot dataSnapshot) {
                    ...
                    MarkerOptions marker = new MarkerOptions().position(mLatlng).title("Price Limit").snippet(price).icon(BitmapDescriptorFactory.fromResource(R.drawable.clip_req));
    ...
    public void onInfoWindowClick(Marker marker) {
        ...
        Intent myIntent = new Intent(getActivity(), InfoReq.class);
        myIntent.putExtra("tag", key);
        startActivity(myIntent);
    }
}
